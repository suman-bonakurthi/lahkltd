...
const solutions = [
  {
    ...
    image: "/assets/home/icons/garment-manufacturing.png",
  },
  {
    ...
    image: "/assets/home/icons/fabric-material.png",
  },
  {
    ...
    image: "/assets/home/icons/product-design.png",
  },
  {
    ...
    image: "/assets/home/icons/quality-control.png",
  },
  {
    ...
    image: "/assets/home/icons/global-shipping.jpg",
  },
  {
    ...
    image: "/assets/home/icons/sustainable-production.jpg",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-bodytext max-w-2xl mx-auto">
            We deliver exactly what your brand needs: reliable, scalable, and
            high-quality garment sourcing and manufacturing solutions. Our
            services are designed to ensure efficiency, quality assurance, and
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {solutions.map((sol, idx) => (
            ...
            >
              ...
              {/* Content */}
              <h3 className="text-xl font-semibold text-bodytext mb-2">
                {sol.title}
              </h3>
              <p className="text-bodytext pt-5">{sol.description}</p>
            </div>
          ))}
        </div>
      </div>
