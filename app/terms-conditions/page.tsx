  ...
  return (
    <div className="min-h-screen pt-8">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-sm text-black mb-8 pt-8">
        ...
        {/* Acknowledgment */}
        <section className="mb-12">
          <h2 className="text-[28px] font-bold text-black mb-8">Acknowledgment</h2>
          <p className="text-black leading-relaxed mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-[28px] font-bold text-black mb-8">Links to Other Websites</h2>
          <p className="text-black leading-relaxed">
        ...
        <section className="mb-12">
          <h2 className="text-[28px] font-bold text-black mb-8">Limitation of Liability</h2>
          <p className="text-black leading-relaxed">
        ...
        {/* Governing Law */}
        <section className="mb-12">
          <h2 className="text-[28px] font-bold text-black mb-8">Governing Law</h2>
          <p className="text-black leading-relaxed">
        ...
        <section className="mb-12">
          <h2 className="text-[28px] font-bold text-black mb-8">Changes to These Terms and Conditions</h2>
          <p className="text-black leading-relaxed">
