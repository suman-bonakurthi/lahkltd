  ...
  return (
    <div className="min-h-screen pt-8">
      ...
      <div >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-secondary text-white py-16 text-center">
              ...
              Terms and Conditions for L&amp;A Web Services
            </h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-base text-headtext mb-8 pt-8">
        ...
        {/* Acknowledgment */}
        <section className="mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-headtext mb-8">Acknowledgment</h2>
          <p className="text-headtext leading-relaxed mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-headtext mb-8">Links to Other Websites</h2>
          <p className="text-headtext leading-relaxed">
        ...
        <section className="mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-headtext mb-8">Limitation of Liability</h2>
          <p className="text-headtext leading-relaxed">
        ...
        {/* Governing Law */}
        <section className="mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-headtext mb-8">Governing Law</h2>
          <p className="text-headtext leading-relaxed">
        ...
        <section className="mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-headtext mb-8">Changes to These Terms and Conditions</h2>
          <p className="text-headtext leading-relaxed">
