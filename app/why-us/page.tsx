...
const featureSections = [
  ...
  },
  {
    icon: Target,
    title: "Our Vision",
    image: "/assets/why-us/our-vision.jpg",
    description:
          ...
          <div className="space-y-20">
            {featureSections.map((feature, index) => (
              ...
              >
                ...
                {/* Content Side */}
                <div
                  className={`${index % 2 === 1 ? "md:order-1" : ""} w-full`}
                >
                  <div className="border-l-4 border-primary pl-6">
                    ...
                    <div className="text-bodytext mb-14 max-w-2xl mx-auto text-base text-justify">
                      {feature.description
                        .split("\n\n")
      ...
      <section className="pb-24">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-base leading-relaxed max-w-2xl mx-auto text-justify">
              Discover why leading brands around the world choose to partner
              with us.
            </p>
          </div>
            ...
            {whyUsItems.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-bodytext mb-14 max-w-2xl mx-auto text-base text-justify flex-1">
                    <p>{item.text}</p>
                  </div>
                </div>
              );
